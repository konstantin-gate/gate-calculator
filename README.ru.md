...
<p align="center">
  ...
  <a href="README.cs.md" title="Czech version"><img src="https://img.shields.io/badge/cs-Čeština-yellow?style=flat-square" alt="Чешская версия"></a>
</p>

## Что это

Нативный калькулятор для macOS, вдохновлённый Calculator.app из macOS Tahoe, написанный на Swift 6.0 с использованием SwiftUI и архитектуры MVVM — вычислительный движок отделён от UI и полностью потокобезопасен (`Sendable`).
